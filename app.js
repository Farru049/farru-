...
var quiz = { "JS" : [
    ...
    {
        "id" : 2,
        "question" : "Which country drinks the most coffees per capita",
        "options" : [
            {"a":"America", 
             "b":"Russia", 
             "c":"Finland",
    ...
    {
        "id" : 3,
        "question" :"Who discovereed that the earth earth revolves around the sun?",
        "options" : [
    ...
    {
        "id" : 5,
        "question" : "what's the world's fastest bird",
        "options" : [
